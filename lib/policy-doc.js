...
function buildChildren(v) {
  ...
  if (!v.support.oh) {
    c.push(p(`11.3 The organisation does not retain an occupational health service. Fitness-for-work questions that need clinical input will be referred to the individual\u2019s GP or an appropriate external adviser, arranged through the ${roleRef(owner)}.`));
  }
