...
<style>
 body{font-family:'Open Sans',Arial,sans-serif;color:#2c2d2f;background:#f4f6f7;margin:0;padding:28px;line-height:1.55}
 h1{font-size:22px;margin:0 0 4px} p.lede{color:#5d6467;margin:0 0 22px;font-size:14px;max-width:760px}
 .doc{background:#fff;border:1px solid #dfe6e9;border-radius:8px;padding:20px 22px;margin:0 0 18px;max-width:900px}
 .t{font-weight:700;font-size:16px} .file{color:#5d6467;font-size:12px;font-family:ui-monospace,monospace}
 .chip{display:inline-block;font-size:12px;padding:3px 10px;border-radius:999px;margin-left:8px;vertical-align:middle}
 ...
 .role{font-size:13px;color:#5d6467;margin:6px 0 10px}
 h3{font-size:13px;margin:14px 0 4px;color:#1d6478;text-transform:none}
 ul{margin:4px 0 8px;padding-left:20px;font-size:13.5px} li{margin:0 0 4px}
 details{margin:12px 0} summary{cursor:pointer;font-size:14px;color:#1d6478;font-weight:600}
 iframe{width:100%;height:640px;border:1px solid #dfe6e9;border-radius:6px;margin-top:10px;background:#fff}
 .signrow{margin-top:14px;padding-top:14px;border-top:1px solid #eef2f4}
 input[type=text]{font:inherit;padding:8px 10px;border:1px solid #c6d0d4;border-radius:6px;width:220px}
 button{font:inherit;padding:9px 16px;border-radius:6px;border:1px solid #2a8ba3;background:#2a8ba3;color:#fff;cursor:pointer}
   ...
   api('/api/admin/signoff/docs').then(function (d) {
     ...
     el.innerHTML = d.docs.map(function (doc) {
       ...
       return '<div class="doc">' +
         ...
         '<details><summary>Read the document</summary><iframe src="/admin/signoff/preview/' + encodeURIComponent(doc.file) + '?token=' + encodeURIComponent(TOKEN) + '" title="Preview"></iframe></details>' +
